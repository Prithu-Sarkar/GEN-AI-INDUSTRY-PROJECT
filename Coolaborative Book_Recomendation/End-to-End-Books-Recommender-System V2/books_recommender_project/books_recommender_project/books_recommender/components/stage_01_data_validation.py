...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ...
            clean_path = os.path.join(self.data_validation_config.clean_data_dir, 'clean_data.csv')
            ...
            pickle.dump(final_rating, open(os.path.join(ser_dir, 'final_rating.pkl'), 'wb'))
